...
$item_price = 3000; // You can adjust this value as needed
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($referal && $current_gold >= $item_price) {
        ...
        $title = "Purge of the Undying Knight";
...
<div class="menu-container" style="margin-top:80px">
    ...
    <div class="item-details">
        <img src="Items/staff.png" alt="Wooden Sword" style="width: 100px;" />
    </div>
    <div class="item-details">
        <p class="item-name">Elemental Staff</p>
        <p class="item-name">Price: 3000 Gold</p>
    </div>
