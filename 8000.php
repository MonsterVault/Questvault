...
$item_price = 8000; // You can adjust this value as needed
...
if ($invitecode2) {
    ...
    if ($referal_stmt2->num_rows > 0) {
        ...
        $message_stmt2->bind_param("sss", $message2, $regdate, $invitecode2); // Correctly use $invitecode2
...
<div class="menu-container" style="margin-top:80px">
    ...
    <div class="item-details">
        <img src="Items/teleport.png" alt="Wooden Sword" style="width: 100px;" />
    </div>
    <div class="item-details">
        <p class="item-name">Abbysal Warpstone</p>
        <p class="item-name">Price: 8000 Gold</p>
    </div>
